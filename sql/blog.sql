...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 23 nov. 2020 à 07:55
...
CREATE TABLE IF NOT EXISTS `comment` (
  ...
  `valided` int(11) NOT NULL DEFAULT '0',
...
(104, 22, 41, 'dernier commentaire', 1, '2020-11-22 18:44:12');
...
(44, 'Marzipan tart', 'Jelly gummi bears lollipop sweet sweet roll pie cotton candy icing. I love chocolate cotton candy I love cookie. Oat cake oat cake chocolate bar brownie candy canes sugar plum. Apple pie pastry chocolate jujubes.', 'Cake fruitcake lollipop caramels marzipan marshmallow toffee cheesecake dragÃ©e. Bear claw chupa chups pie. Wafer tiramisu chocolate cake soufflÃ© sweet sesame snaps soufflÃ© sweet roll. Lemon drops I love gummies gummi bears jelly-o soufflÃ©. Marzipan bear claw oat cake topping topping I love jujubes. Dessert bonbon marshmallow fruitcake tart cupcake marzipan sweet roll. I love cupcake bonbon marzipan fruitcake soufflÃ© muffin caramels muffin. Biscuit dessert liquorice ice cream lollipop candy canes sweet roll cheesecake. Caramels cookie chocolate cake croissant. Bonbon carrot cake sweet roll soufflÃ© dessert pudding cotton candy jujubes. Icing lollipop ice cream. Gingerbread carrot cake I love. Jelly chocolate cake I love dragÃ©e sugar plum.\r\n\r\nPudding cookie cake biscuit croissant jujubes marzipan lemon drops apple pie. Cake jelly beans tiramisu jelly-o I love. Donut cookie icing. I love danish tootsie roll topping chocolate bar cheesecake. Chocolate carrot cake gummi bears sweet roll chocolate bar. Biscuit chocolate carrot cake fruitcake oat cake oat cake. Bear claw caramels dessert apple pie apple pie brownie sesame snaps. I love cake cupcake. I love caramels jelly muffin. I love biscuit I love tootsie roll. Oat cake cookie bonbon ice cream tart soufflÃ©. Tootsie roll I love pie gingerbread tiramisu jelly-o jelly beans wafer.\r\n\r\nPudding danish muffin gummies. Cotton candy marshmallow sweet danish bear claw cotton candy topping bonbon bonbon. Icing gummi bears cake pie cotton candy marzipan. Cookie halvah toffee biscuit cheesecake sweet roll cotton candy cake halvah. Sesame snaps cheesecake oat cake gummies sesame snaps. Liquorice tiramisu caramels tart chocolate. Croissant jelly sugar plum dessert tootsie roll. Candy canes halvah gingerbread. Sesame snaps dragÃ©e apple pie sweet roll biscuit. Jelly-o liquorice icing I love fruitcake I love. Muffin bear claw cake cake marshmallow liquorice I love bonbon. Brownie tart I love caramels cake sweet roll. Brownie marzipan topping jelly beans.', 1, '2020-11-22 19:10:09', '2020-11-22 19:10:09');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `valided` int(10) NOT NULL DEFAULT '1',
...
(1, 'demo', 'jpetitgas63@gmail.com', '89e495e7941cf9e40e6980d14a16bf023ccd4c91', 2, 2),
(22, 'jp', 'jp@jp', '0f41a0b3b760b54df703e860e40fef1c388ed2c5', 2, 1),
(23, 'jerome', 'jerom@frf.fr', '723156650c5778d0e4df4b2fbfeefa65359302e5', 1, 1);
COMMIT;
